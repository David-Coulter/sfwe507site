...
urlpatterns = [
    ...
    path('sprints/', views.sprint_backlog, name='sprint_backlog'),
    path('task_<int:task_pk>/move-to-sprint/<int:sprint_pk>/', views.move_to_sprint, name='move_to_sprint'),
    path('task_<int:task_pk>/sprint-progress/<str:new_progress>/', views.update_sprint_progress, name='update_sprint_progress'),
